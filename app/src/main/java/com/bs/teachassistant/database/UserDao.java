...
public class UserDao extends AbstractDao<User, String> {
    ...
    public static class Properties {
        ...
        public final static Property Permission = new Property(4, int.class, "permission", false, "PERMISSION");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"PHONE\" TEXT," + // 2: phone
                "\"SEX\" TEXT," + // 3: sex
                "\"PERMISSION\" INTEGER NOT NULL );"); // 4: permission
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(5, entity.getPermission());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getInt(offset + 4) // permission
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setPermission(cursor.getInt(offset + 4));
     }
