...
public class PositionUtil {
    ...
    public static double ee =1 / 298.257223563;
     ...
     */
    public static Position gcj_To_Gps84(double lat, double lon) {
    ...
    public static Position bd09_To_Gps84(double bd_lat, double bd_lon) {
        ...
        Position gcj02 = PositionUtil.bd09_To_Gcj02(bd_lat, bd_lon);
        Position map84 = PositionUtil.gcj_To_Gps84(gcj02.getWgLat(),
                gcj02.getWgLon());
        return map84;
    ...
    public static Position transform(double lat, double lon) {
        if (outOfChina(lat, lon)) {
    ...
    public static void main(String[] args) {
        ...
        Position gps = new Position(31.426896, 119.496145);
        System.out.println("gps :" + gps);
        Position gcj = gps84_To_Gcj02(gps.getWgLat(), gps.getWgLon());
        System.out.println("gcj :" + gcj);
        Position star = gcj_To_Gps84(gcj.getWgLat(), gcj.getWgLon());
        System.out.println("star:" + star);
        Position bd = gcj02_To_Bd09(gcj.getWgLat(), gcj.getWgLon());
        System.out.println("bd  :" + bd);
        Position gcj2 = bd09_To_Gcj02(bd.getWgLat(), bd.getWgLon());
